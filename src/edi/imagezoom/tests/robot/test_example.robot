...
#
#  $ bin/test -s edi.imagezoom -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src edi.imagezoom.testing.EDI_IMAGEZOOM_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/edi/imagezoom/tests/robot/test_example.robot
#
